...
import static ovh.ladon.challenge.Main.findMostRepeatedWord;
...
class ChallengeTest {
	...
	void testCase1() {
		...
		assertEquals(findMostRepeatedWord(testString), "lorem");//4times
	}
	...
	void testCase2() {
		...
		assertEquals(findMostRepeatedWord(testString2), "penguins");//3times
	}
	...
	void testCase3() {
		...
		assertEquals(findMostRepeatedWord(testString3), "used");//4times
	}
